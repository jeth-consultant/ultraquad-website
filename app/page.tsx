  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <header className="flex justify-between items-center px-6 py-4 bg-gray-800 shadow-md">
        <h1 className="text-2xl font-bold text-blue-400">Ultra Quad</h1>
      ...
      <section className="flex flex-col items-center justify-center text-center px-4 py-24 bg-gray-900">
        ...
        <p className="text-lg text-gray-300 max-w-2xl mb-8">
          Empowering startups and enterprises with cutting-edge web and AI
          solutions. Build smarter, faster, and better.
        </p>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-8 px-6 py-20 bg-gray-950">
        {[
          ...
          },
          {
            ...
            description:
              "Deploy fast and scale infinitely with cloud-native tools.",
            icon: "☁️",
          },
          {
            title: "Web Development",
            description:
              "Modern, scalable web apps built with cutting-edge tech.",
            icon: "💻",
          },
