...
export default function About() {
  return (
    <section id="about" className="min-h-screen bg-white relative overflow-hidden flex items-center">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="text-center mb-16">
          <p className="text-sky-500 font-medium tracking-widest uppercase mb-4">
            Who We Are
          </p>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-4">
              {values.map((value: ValueItem, index: number) => (
                <div key={index} className="flex items-center">
                  ...
                  <span className="text-gray-700 text-lg">{value.text}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="flex justify-center md:justify-end">
            <div className="bg-gray-50 p-8 rounded-2xl border border-gray-200 shadow-xl hover:shadow-sky-100 transition-all duration-300 max-w-md">
              <div className="aspect-video bg-gradient-to-br from-sky-50 to-blue-100 rounded-2xl flex items-center justify-center border border-gray-200">
                <div className="text-center p-6">
                  ...
                  <h4 className="text-2xl font-bold text-gray-900 mb-2">Digital Transformation</h4>
                  <p className="text-gray-600">Future-proof your business with innovative solutions</p>
                </div>
              </div>
            </div>
          </div>
